...
- Choose a workflow below (Audio, Visual or AI) and tell Nitin  - the facilitator - letting them know which path you’re going to explore.

- Set up your Laptop/Host Machine following the steps mentioned here [here](TBD) (scroll down to ‘Host machine requirements'). You will set up either a virtual host on your existing OS or an Ubuntu 22.04 host on baremetal. You will also need an external monitor and an HDMI cable for the sample applications.  
...
## Build procedures  ~4-6 hrs  
### Task 1: Download and build source code of RB3Gen2 using GUI tools
The goal is to download Qualcomm software using tools and build it and eventually program an existing RB3Gen2 with compiled code.
...
- Program the compiled build on RB3Gen2.

### Task 2: Download and build source code of RB3Gen2 using git commands
The goal is to downlod Qualcomm software using git.
...
Work on the task that is assigned to you based on your skill.Please provide feedback as you navigate Qualcomm documentation in the excel sheet provided to you. 
...
## Setup Device and explore the Sample application ~1-2 hrs  

The goal is to setup the Qualcomm Reference hardware provided and your Host PC and explore the capablities of the hardware .
...
#### Testing and Feedback  
- Test the application on the IQ9 Beta DevKit.
